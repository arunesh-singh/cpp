...
{
    Length l1,l2,l1Copy;
    cout<<"\nMagnitude of Data Set 1 should be greater than Data Set 2\notherwise subtraction of the two lenghts may sometimes\ngive negative result."<<endl;
    cout<<"\n\t-----Data Set 1-----"<<endl;
    l1.input();
    l1Copy=l1;
    cout<<"\n\t-----Data Set 2-----"<<endl;
    l2.input();
    cout<<"--------------------------------------------------------------"<<endl;
    cout<<"\n\t----Result of the addition of the two lengths----"<<endl;
    l1+l2;
    display(l1);
    l1Copy-l2;
    cout<<"\n\t----Result of the subtraction of the two lengths----"<<endl;
    display(l1Copy);
    return 0 ;
